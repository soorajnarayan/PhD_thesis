      ...
      if(nDim.eq.2) then
         ...
         do i=1,nNode
            do j=1,nNode
               ...
               ! temperature
               !
               amatrx(A11+3,B11+3) = Komgomg(i,j)
               !
               ...
               !
               amatrx(A11+2,B11+3) = Kphiomg(i,j)
               !
               ! temperature - displacement
               !
               amatrx(A11+3,B11) = Komgu(i,B12)
               amatrx(A11+3,B11+1) = Komgu(i,B12+1)
               !
               ! temperature - chemical potential
               !
               amatrx(A11+3,B11+2) = Komgphi(i,j)
               !
            enddo
         enddo
         !
